...
for entry in all:
    if ( lookup(entry, 'Track ID') is None ) : continue   #Sanity Check: If there is nothing, skip it.
    ...
    if name is None or genre is None or artist is None or album is None : continue #Sanity Check: If there is nothing, skip it.
